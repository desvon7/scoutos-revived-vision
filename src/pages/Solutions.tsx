      ...
      <section className="py-16 md:py-24 bg-gradient-to-b from-background to-secondary/20">
        <div className="container-custom text-center max-w-3xl mx-auto">
          ...
          <p className="text-lg md:text-xl mb-10 text-muted-foreground max-w-2xl mx-auto">
            Discover how Scout's AI platform can transform your business operations and customer
            experiences.
          </p>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="p-6 border border-border rounded-lg bg-card">
              ...
              <p className="text-muted-foreground mb-4">
                AI solutions for risk assessment, fraud detection, customer service, and regulatory
            ...
            <div className="p-6 border border-border rounded-lg bg-card">
              ...
              <p className="text-muted-foreground mb-4">
                AI applications for patient care, administrative efficiency, and healthcare research
                and development.
              </p>
              <ul className="space-y-2 mb-6">
                <li className="text-sm flex items-start">
            ...
            <div className="p-6 border border-border rounded-lg bg-card">
              ...
              <p className="text-muted-foreground mb-4">
                AI solutions to enhance customer experience, optimize operations, and drive sales
                growth in retail environments.
              </p>
              <ul className="space-y-2 mb-6">
                <li className="text-sm flex items-start">
                  <span className="text-primary mr-2">•</span>
            ...
            <div className="p-6 border border-border rounded-lg bg-card">
              ...
              <p className="text-muted-foreground mb-4">
                AI integrations for technology companies and SaaS platforms to enhance product
            ...
            <div className="p-6 border border-border rounded-lg bg-card">
              ...
              <p className="text-muted-foreground mb-4">
                AI solutions for government agencies and public sector organizations to improve
            ...
            <div className="p-6 border border-border rounded-lg bg-card">
              ...
              <p className="text-muted-foreground mb-4">
                AI tools for educational institutions to enhance learning experiences,
                administrative processes, and research capabilities.
              </p>
              <ul className="space-y-2 mb-6">
                <li className="text-sm flex items-start">
                  <span className="text-primary mr-2">•</span>
