        ...
        return (
          <>
            ...
            <div className="flex gap-3 mt-4">
              ...
              <Button className="flex-1" onClick={() => setStep('organization')}>
                Continue
              </Button>
            </div>
          </>
          ...
          <>
            <div className="text-center mb-6">
              ...
              <p className="text-sm text-muted-foreground">
                This helps us customize your workflows
              </p>
            </div>
            ...
            <div className="space-y-4 mb-6">
              <div>
                ...
                <Input id="orgName" type="text" placeholder="Your company or team name" />
              </div>
            ...
            <div className="flex gap-3 mt-4">
              <Button variant="outline" className="flex-1" onClick={() => setStep('usage')}>
                Back
              </Button>
        ...
        <div className="p-8">
          <div className="flex flex-col items-center mb-6">
            ...
            <p className="text-muted-foreground text-sm">
              Welcome to Flow AI! Please fill in the details to get started.
            </p>
          </div>
