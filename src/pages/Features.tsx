      ...
      <section className="py-16 md:py-24 bg-gradient-to-b from-background to-secondary/20">
        <div className="container-custom text-center max-w-3xl mx-auto">
          ...
          <p className="text-lg md:text-xl mb-10 text-muted-foreground max-w-2xl mx-auto">
            Scout provides everything you need to build, deploy, and scale AI applications that
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="p-6 border border-border rounded-lg bg-card">
              ...
              <p className="text-muted-foreground mb-4">
                Connect your data sources, create AI-ready knowledge bases, and build retrieval
                systems for accurate and context-aware responses.
              </p>
              ...
              <Link
                to="/features/knowledge-management"
            ...
            <div className="p-6 border border-border rounded-lg bg-card">
              ...
              <p className="text-muted-foreground mb-4">
                Build and deploy customized AI assistants that understand your business context and
                can be integrated into your existing workflows.
              </p>
              <ul className="space-y-2 mb-6">
                <li className="text-sm flex items-start">
                  <span className="text-primary mr-2">•</span>
            ...
            <div className="p-6 border border-border rounded-lg bg-card">
              ...
              <p className="text-muted-foreground mb-4">
                Access, manage, and optimize a wide range of AI models to find the perfect balance
                of performance, cost, and capabilities for your use case.
              </p>
              <ul className="space-y-2 mb-6">
                <li className="text-sm flex items-start">
                  <span className="text-primary mr-2">•</span>
            ...
            <div className="p-6 border border-border rounded-lg bg-card">
              ...
              <p className="text-muted-foreground mb-4">
                Create complex AI workflows that combine multiple models, data sources, and business
                logic to solve sophisticated problems.
              </p>
              <ul className="space-y-2 mb-6">
                <li className="text-sm flex items-start">
                  <span className="text-primary mr-2">•</span>
            ...
            <div className="p-6 border border-border rounded-lg bg-card">
              ...
              <p className="text-muted-foreground mb-4">
                Gain deep insights into your AI systems' performance, usage patterns, and costs to
                continuously optimize your solutions.
              </p>
              <ul className="space-y-2 mb-6">
                <li className="text-sm flex items-start">
                  <span className="text-primary mr-2">•</span>
            ...
            <div className="p-6 border border-border rounded-lg bg-card">
              ...
              <p className="text-muted-foreground mb-4">
                Create high-quality, customized content at scale for marketing, documentation,
                support, and more.
              </p>
              <ul className="space-y-2 mb-6">
                <li className="text-sm flex items-start">
              ...
              <Link
                to="/features/content-generation"
                className="text-sm font-medium inline-flex items-center hover:underline"
              >
                Learn more <ArrowRight className="h-3 w-3 ml-1" />
              </Link>
            ...
            <div className="p-6 border border-border rounded-lg bg-card">
              ...
              <p className="text-muted-foreground mb-4">
                Comprehensive APIs, SDKs, and developer resources to build custom AI-powered
                applications with full flexibility.
              </p>
              <ul className="space-y-2 mb-6">
                <li className="text-sm flex items-start">
                  <span className="text-primary mr-2">•</span>
            ...
            <div className="p-6 border border-border rounded-lg bg-card">
              ...
              <p className="text-muted-foreground mb-4">
                Comprehensive security, compliance, and governance features designed for
