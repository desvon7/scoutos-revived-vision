...
export function useWorkflow() {
  ...
  const [nodes, setNodes] = useState<NodeObject[]>([
    { id: '1', title: 'Slack', type: 'input' as NodeType, x: 100, y: 80, data: { inputName: 'slack_message' } },
    { id: '2', title: 'Memory', type: 'memory' as NodeType, x: 260, y: 80, data: { memoryType: 'conversation' } },
    { id: '3', title: 'Check', type: 'process' as NodeType, x: 420, y: 80, data: { processType: 'extract' } },
    { id: '4', title: 'Collection', type: 'collection' as NodeType, x: 260, y: 150, data: { collection: 'documentation' } },
    { id: '5', title: 'LLM', type: 'llm' as NodeType, x: 420, y: 220, data: { model: 'gpt-4o', temperature: 0.7 } },
  ]);
