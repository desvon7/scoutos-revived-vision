...
import { 
  Workflow, Node, Connection, NodeType, 
  ExecutionState, NodeExecutionState, ExecutionContext 
} from '../types/nodes';
...
export class WorkflowExecutionEngine {
  ...
  private async executeNode(node: Node, workflow: Workflow, context: ExecutionContext): Promise<any> {
  ...
  private async getNodeInputs(node: Node, workflow: Workflow, context: ExecutionContext): Promise<Record<string, any>> {
  ...
  private async handleTextInput(node: Node, inputs: Record<string, any>, context: ExecutionContext) {
  ...
  private async handleJavaScript(node: Node, inputs: Record<string, any>, context: ExecutionContext) {
    try {
