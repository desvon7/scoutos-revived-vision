...
export const ScoutLogo = () => {
  return (
    ...
    >
      ...
      />
      <path
        d="M16 7.6c-4.625 0-8.4 3.775-8.4 8.4s3.775 8.4 8.4 8.4 8.4-3.775 8.4-8.4-3.775-8.4-8.4-8.4zm0 14c-3.094 0-5.6-2.506-5.6-5.6s2.506-5.6 5.6-5.6 5.6 2.506 5.6 5.6-2.506 5.6-5.6 5.6z"
        fill="currentColor"
      />
