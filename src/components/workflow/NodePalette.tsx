...
const nodeGroups = [
  ...
  },
  {
    ...
    items: [
      ...
      { type: NodeType.GPT_35_TURBO, label: 'GPT-3.5 Turbo', icon: <BrainIcon className="w-4 h-4" /> },
      { type: NodeType.CLAUDE_3_OPUS, label: 'Claude 3 Opus', icon: <BrainIcon className="w-4 h-4" /> }
    ]
  },
  {
    title: 'Logic',
  ...
  },
  {
    title: 'Data',
    items: [
      { type: NodeType.COLLECTION, label: 'Collection', icon: <DatabaseIcon className="w-4 h-4" /> },
